...
$sql = "SELECT 
    ...
    p.Program_Category
FROM Program p
LEFT JOIN Enrolment e ON p.Program_ID = e.Program_ID
LEFT JOIN Program_trainer pt ON pt.Program_ID = p.Program_ID
AND pt.Start_Date = (SELECT MAX(pt2.Start_Date) FROM Program_trainer pt2 WHERE pt2.Program_ID = p.Program_ID)
LEFT JOIN Trainer t ON pt.Trainer_ID = t.Trainer_ID
GROUP BY p.Program_ID, p.Program_Name, t.Trainer_FName, t.Trainer_LName, p.Program_Category
